...
const Hero = () => {
  return (
    <section className="min90rem:min-h-fit min90rem:py-16 flex-center section-padding min-h-mainHeight bg-heroGradient">
      <div className="flex-between container flex-col gap-8 md:flex-row">
        <div className="md:w-1/2">
          ...
          <p className="mt-4 indent-8 text-sm md:mt-8 md:text-md lg:text-lg">
